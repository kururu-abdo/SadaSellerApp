...
class TitleRow extends StatelessWidget {
  ...
  TitleRow({@required this.title, this.onTap, this.eventDuration, this.isDetailsPage, this.isPrimary=false});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      Text(title, style: robotoBold.copyWith(color: isPrimary? ColorResources.titleColor(context):Theme.of(context).primaryColor)),
      eventDuration == null
              ...
              child: Row(children: [
                ...
                Padding(
                  ...
                  child: Icon(Icons.arrow_forward,
                    color: isDetailsPage == null ? ColorResources.commissionCardColor(context) : Theme.of(context).hintColor,
