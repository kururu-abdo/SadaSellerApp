...
import 'package:joseeder_seller/view/screens/addProduct/widget/add_product_next_Screen.dart';
import 'package:joseeder_seller/view/screens/addProduct/widget/select_category_widget.dart';
import 'package:joseeder_seller/view/screens/addProduct/widget/title_and_description_widget.dart';
...
class _AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if(widget.product != null){
      ...
      Provider.of<RestaurantProvider>(context,listen: false).setValueForUnit(widget.product.unit.toString()) ;
    }else{
           ...
           builder: (context,resProvider, _) {
             return Container(height: 50,
               ...
               onTap: (){
                 ...
                 else if (resProvider.unitValue == '' || resProvider.unitValue == null) {
  ...
  List<Widget> _generateTabChildren() {
    ...
    for(int index=0; index < Provider.of<SplashProvider>(context, listen: false).configModel.languageList.length; index++) {
      _tabs.add(Text(Provider.of<SplashProvider>(context, listen: false).configModel.languageList[index].name,
