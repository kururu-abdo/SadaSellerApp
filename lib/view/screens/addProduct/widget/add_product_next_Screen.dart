...
import 'package:eamar_seller_app/view/base/attribute_view.dart';
...
import 'package:eamar_seller_app/view/screens/addProduct/widget/add_product_seo_screen.dart';
          ...
          child: Consumer<RestaurantProvider>(
            builder: (context, resProvider, child){
              ...
              _colors.add(0);
                ...
                if (_update && Provider.of<RestaurantProvider>(context, listen: false).attributeList != null &&
                    Provider.of<RestaurantProvider>(context, listen: false).attributeList.length > 0) {
                  if(addColor==0) {
                    addColor++;
